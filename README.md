...
```bash
git clone https://github.com/GIT-GHOSTED/GG-Front-End.git    #Front-End
git clone https://github.com/GIT-GHOSTED/GG-Back-End.git     #Back-End
```
...
```
PORT=5000
DATABASE_URL=postgresql://postgres:yourpassword@localhost:5432/GIT-GHOSTED
